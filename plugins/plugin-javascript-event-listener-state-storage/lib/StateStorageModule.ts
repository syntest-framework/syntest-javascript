...
export default class StateStorageModule extends Module {
  ...
  override register(extensionRegistrationApi: ExtensionRegistrationAPI): void | Promise<void> {
    extensionRegistrationApi.registerPlugin(new StateStorageEventListenerPlugin());
  }
}
