...
//         const coveredBy = new Map<ObjectiveFunction<JavaScriptTestCase>, Set<JavaScriptTestCase>>(objectives.map((objective) => [objective, new Set()]))
//         for (const encoding of encodings) {
//             const executionResult = encoding.getExecutionResult();
...
//                     coveredBy.get(objective).add(encoding)
//                 }
//             }
//           }

//           for (const [objective, encodings] of coveredBy.entries()) {
//             if (encodings.size !== 1) {
//                 continue
//             }
//             const encoding = [...encodings][0]
//             if (objective instanceof ExceptionObjectiveFunction) {
//               encoding.addMetaComment(`Selected for:`);
//               for (const line of objective.error.stack.split("\n")) {
//                 encoding.addMetaComment(`\t${line}`);
//               }
//               encoding.addMetaComment("");
//             } else {
//               encoding.addMetaComment(
//                 `Selected for objective: ${objective.getIdentifier()}`
//               );
//             }
//           }
//     }
